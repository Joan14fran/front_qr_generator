...
import { getQRsEmail, updateQREmail, deleteQREmail } from '../api/qrs.api';
...
export function ListQRMail() {
    ...
    const updateQRHandler = async () => {
        if (selectedQR) {
            try {
                ...
                await updateQREmail(selectedQR.id, updatedQR);
                toast.current?.show({
                    severity: 'success',
                    summary: 'Éxito',
    ...
    const deleteQRHandler = async () => {
        if (selectedQR) {
            try {
                await deleteQREmail(selectedQR.id);
                toast.current?.show({
                    severity: 'info',
                    summary: 'Éxito',
