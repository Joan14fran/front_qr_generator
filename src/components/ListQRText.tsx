...
import { getQRsText, updateQRText, deleteQRText } from '../api/qrs.api';
...
export function ListQRText() {
    ...
    const updateQRHandler = async () => {
        if (selectedQR) {
            try {
                ...
                await updateQRText(selectedQR.id, updatedQR);
                toast.current?.show({
                    severity: 'success',
                    summary: 'Éxito',
    ...
    const deleteQRHandler = async () => {
        if (selectedQR) {
            try {
                await deleteQRText(selectedQR.id);
                toast.current?.show({
                    severity: 'info',
                    summary: 'Éxito',
